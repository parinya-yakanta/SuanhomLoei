...
<body>
    ...
    <div class="container">
		...
		<div class="customers-box">
			<h2>ข้อมูลคลังภูมิปัญญาท้องถิ่น</h2>
			<div class="row">
				<!-- Blog Entries Column -->
						...
						<table class="table table-responsive-sm">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $row["KM_TOPIC"]; ?></td>
									<td><?php echo date('d-M-Y',strtotime($row["KM_UPDATE"])); ?></td>
									<td><a href="kmdataedit.php?idkm=<?php echo $row["KM_ID"]; ?>"><i class="fa fa-cog"></i></a></td>
								</tr>
							<?php	} ?>
							<tr>
								<td><?php echo $count_num++; ?></td>
								...
								<td><i class="fa fa-plus"></i></td>
								<td><a href='kmdataadd.php' class=''>เพิ่มข้อมูล</a></td>
							</tr>
							</tbody>
						</table>
				  </div>
