        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
               <ul class="navbar-nav ml-auto">
                  <li class="nav-item">
                     <a class="nav-link active" href="adminindex.php">หน้าหลัก</a>
                  </li>
    ...
    <header class="slider-main">
		...
		<div class="container">
			...
			<div class="contact-left">
				...
				<form role="form" id="formSerch" name="formSerch" method="GET" action="adminindex.php?uid=<?php echo $UID;?>">
		...
		if($_GET['txt_search'])
    {
		...
		<div class="pagination_bar">
			...
			<ul class="pagination justify-content-center">
				<li class="page-item">
				  <a class="page-link" href="adminindex.php?page=1" aria-label="Previous">
				...
				<li class="page-item">
					<a class="page-link" href="adminindex.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
				</li>

			  <?php } ?>

				<li class="page-item">
				  <a class="page-link" href="adminindex.php?page=<?php echo $total_page;?>" aria-label="Next">
